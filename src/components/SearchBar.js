        ...
        <div className="search-bar-div">
            <form>
                ...
                <ul className="search-columns">
                    <button type="submit" data-test-id="searchButton" class="y2_btn primary search_button"> <span class="button_content"><i class="y2i_search"></i> <span class="button_text">חיפוש</span></span></button><div class="dropdown_btn"><button type="button" class="y2_btn advanced_search_button grey"> <span class="button_content"><i class="y2i_plus_o"></i> <span class="button_text">חיפוש מתקדם</span></span></button></div>
                    <li>אזור
                    ...
                    <input className="search-bar-input" type="text" name="" autocomplete="off" placeholder="ממחיר" ></input>
                        <input className="search-bar-input" type="text" name="" autocomplete="off" placeholder="עד מחיר" class="text_input"></input>
                    </li>
                    <li>שנה
